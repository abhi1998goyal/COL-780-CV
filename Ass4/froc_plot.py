...
def plot_froc_curve(froc_fpis, froc_sens):
    plt.figure(figsize=(10, 6))
    plt.plot(froc_fpis, froc_sens, marker='o', linestyle='-')
...
if __name__ == '__main__':
    PREDS_PATH = "/kaggle/input/froc-test/test/predictions"
    GT_PATH = "/kaggle/input/froc-test/test/labels"
    prediction_dict = create_pred_data(PREDS_PATH, GT_PATH)
    #calc_froc(prediction_dict)
    froc_fpis, froc_sens = calc_froc(prediction_dict)
    plot_froc_curve(froc_fpis, froc_sens)
