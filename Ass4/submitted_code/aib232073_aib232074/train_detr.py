...
def main():
    ...
    # train_img_folder='/kaggle/input/cv-a4-data/coco_1k/coco_1k/train2017'
    train_img_folder = sys.argv[2]
    # val_img_folder='/kaggle/input/cv-a4-data/coco_1k/coco_1k/val2017'
    val_img_folder = sys.argv[3]
    train_dataset = CocoDetection(img_folder=train_img_folder, processor=processor, train=True)
    val_dataset = CocoDetection(img_folder=val_img_folder, processor=processor, train=False)
