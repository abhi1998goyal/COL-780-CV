...
def detect_hand_gesture(frame):
    ...
    x, y, w, h = cv2.boundingRect(hand_landmarks) 
   ...
   # if results.multi_hand_landmarks:
    ...
    features = np.array(hog.calc_img_hog2(crop))
    ...
    if(len(features))>0:
        ...
        #prediction, decision_score = sv.test_hand(svm_model , np.array(hog.calc_img_hog2(crop)))
